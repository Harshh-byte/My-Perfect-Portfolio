...
export const Timeline = ({
    ...
    return (
        <div
            ...
            ref={containerRef}>
            <h2 className="text-heading">How Can I Help You?</h2>
                    ...
                    <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
                        <div
                            ...
                            <div className="flex-col hidden gap-2 text-xl font-bold md:flex md:pl-20 md:text-4xl text-neutral-300">
                                <h3 className="text-5xl text-neutral-400">{item.title}</h3>
                            </div>
                        </div>
                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full">
                            ...
                            {item.contents.map((content, index) => (<p className="mb-3 font-normal text-neutral-400" key={index}>{content}</p>))}
                        </div>
                    </div>
                ))}
                <div
